...
<html>
	...
	<body>
		...
		<div class="login hidden">
			...
			<form method="POST" action="user/user-home.html" class="login-container">
			...
			<header id="head_page">
				...
				<section>
					...
					<article class="offer_description articles">
						...
						<a href="#" class="button command"> Commander une solution </a>
				...
				<div class="contact_form">
					...
					<form class="form-contact">
						<ul class="form-wrapper">
							<li class="name">
								<i class="fa fa-user form-icon form_icons"></i>
				  				<input id="name" type="text" class="form-control" placeholder="NAME">
				  			</li>
				  			<li class="email">
				  				<i class="ionicons ion-at form_icons"></i>
				  				<input id="email" type="text" class="form-control" placeholder="E-MAIL">
				  			</li>
				  			<li class="subject">
				  				<i class="ionicons ion-ios-paperplane form_icons"></i>
								<input type="text" class="form-control" placeholder="Subject" />
							</li>
							<li class="content">
								<i class="ionicons ion-android-textsms form_icons"></i>
				  				<textarea id="message" type="text" class="form-control" placeholder="MESSAGE"></textarea>
				  			</li>
				  			<li>
		 						<input class="submit-btn" id="submit" type="submit" value="Envoyer">
		 					</li>
		 				</ul>
					</form>
